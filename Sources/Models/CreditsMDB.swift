...
public struct CreditsMDB{
  ...
  public static func credits(_ apiKey: String, creditID: String, language: String, completion: @escaping (_ clientReturn: ClientReturn, _ data: CreditsMDB?) -> ()) -> URLSessionTask{
   return Client.Credits(apiKey, creditID: creditID, language: language){
      apiReturn in
