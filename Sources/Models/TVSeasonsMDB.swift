...
public struct TVSeasonsMDB: ArrayObject{
  ...
  public static func season_number(_ api_key: String, tvShowId: Int!, seasonNumber: Int!, language: String?, completion: @escaping (_ clientReturn: ClientReturn, _ data: TVSeasonsMDB?) -> ()) -> URLSessionTask{
  ...
  public static func credits(_ api_key: String, tvShowId: Int!, seasonNumber: Int!, language: String?, completion: @escaping (_ clientReturn: ClientReturn, _ data: TVCreditsMDB?) -> ()) -> URLSessionTask{
  ...
  public static func externalIDS(_ api_key: String, tvShowId: Int!, seasonNumber: Int!, language: String, completion: @escaping (_ clientReturn: ClientReturn, _ data: ExternalIdsMDB?) -> ()) -> URLSessionTask{
  ...
  public static func images(_ api_key: String, tvShowId: Int!, seasonNumber: Int!, language: String, completion: @escaping (_ clientReturn: ClientReturn, _ data: ImagesMDB?) -> ()) -> URLSessionTask{
  ...
  public static func videos(_ api_key: String, tvShowId: Int!, seasonNumber: Int!, language: String, completion: @escaping (_ clientReturn: ClientReturn, _ data: [VideosMDB]?)-> ()) -> URLSessionTask{
    //     [/tv/11/season/1/credits]
