...
open class CompanyMDB {
  ...
  open class func companyInfo(_ api_key: String!, companyId: Int!, completion: @escaping (_ clientReturn: ClientReturn, _ data:CompanyMDB?) -> ()) -> URLSessionTask{
    return Client.Company(api_key, companyId: companyId){
      apiReturn in
