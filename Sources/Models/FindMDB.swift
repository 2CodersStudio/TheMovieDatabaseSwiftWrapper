...
public struct FindMDB{
  ...
  public static func find(_ apikey: String, id: String, external_source: ExternalIdTypes!,completion: @escaping (_ clientReturn: ClientReturn, _ data: FindMDB?) -> ()) -> URLSessionTask{
    
    return Client.Find(apikey, external_id: id, external_source: external_source.rawValue){
      apiReturn in
      var data: FindMDB?
