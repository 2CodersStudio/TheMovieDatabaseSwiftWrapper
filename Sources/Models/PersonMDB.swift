...
public struct PersonMDB: ArrayObject{
  ...
  public static func person_id(_ api_key: String!, personID: Int!, completion: @escaping (_ clientReturn: ClientReturn, _ data: PersonMDB?) ->()) ->URLSessionTask{
    let urlType = String(personID)
    return Client.Person(urlType, api_key: api_key, language: nil, page: nil){
      apiReturn in
      var data: PersonMDB?
  ...
  public static func movie_credits(_ api_key: String!, personID: Int!, language: String?, completion: @escaping (_ clientReturn: ClientReturn, _ data: PersonMovieCredits?) -> ()) -> URLSessionTask{
    let urlType = String(personID) + "/movie_credits"
    return Client.Person(urlType, api_key: api_key, language: language, page: nil){
      apiReturn in
  ...
  public static func tv_credits(_ api_key: String!, personID: Int!, language: String?, completion: @escaping (_ clientReturn: ClientReturn, _ data: PersonTVCredits?) -> ()) -> URLSessionTask{
  ...
  public static func combined_credits(_ api_key: String!, personID: Int!, language: String?, completion: @escaping (_ clientReturn: ClientReturn, _ data: PersonCreditsCombined?) -> ()) -> URLSessionTask{
  ...
  public static func externalIDS(_ api_key: String!, personID: Int!, completion: @escaping (_ clientReturn: ClientReturn, _ data: ExternalIdsMDB?) -> ()) -> URLSessionTask{
    return Client.Person( String(personID) + "/external_ids", api_key: api_key, language: nil, page: nil){
      apiReturn in
  ...
  public static func images(_ api_key: String!, personID: Int!, completion: @escaping (_ client: ClientReturn, _ data: [Images_MDB]?) -> ()) -> URLSessionTask{
    return Client.Person( String(personID) + "/images", api_key: api_key, language: nil, page: nil){
      apiReturn in
  ...
  public static func tagged_images(_ api_key: String!, personID: Int!, page: Int?, completion: @escaping (_ client: ClientReturn, _ data: TaggedImages?) -> ()) -> URLSessionTask{
    return Client.Person( String(personID) + "/tagged_images", api_key: api_key, language: nil, page: page){
      apiReturn in
  ...
  public static func latest(_ api_key: String!, completion: @escaping (_ clientReturn: ClientReturn, _ data: PersonMDB?) -> ()) -> URLSessionTask{
    return Client.Person("latest", api_key: api_key, language: nil, page: nil){
      apiReturn in
      var data: PersonMDB?
      if(apiReturn.error == nil){
        data = PersonMDB.init(results: apiReturn.json!)
  ...
  public static func popular(_ api_key: String!, page: Int?, completion: @escaping (_ clientReturn: ClientReturn, _ data: [PersonResults]?) -> ()) -> URLSessionTask{
    return Client.Person("popular", api_key: api_key, language: nil, page: page){
      apiReturn in
  ...
  public static func personAppendTo(_ api_key: String!, personID: Int!, append_to: [String], completion: @escaping (_ clientReturn: ClientReturn, _ data: PersonMDB?, _ json: JSON?) ->()) -> URLSessionTask{
    let urlType =  String(personID)
    return Client.Person(urlType, api_key: api_key, language: nil, page: nil, append_to: append_to){
      apiReturn in
      var data: PersonMDB?
      if(apiReturn.error == nil){
        data = PersonMDB.init(results: apiReturn.json!)
