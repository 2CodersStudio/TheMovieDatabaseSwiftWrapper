...
public struct ConfigurationMDB {
  ...
  public static func configuration(_ api_key: String!, completion: @escaping (_ clientReturn: ClientReturn, _ data: ConfigurationMDB?) -> ()) -> URLSessionTask{
    return Client.Configuration(api_key){
      apiReturn in
