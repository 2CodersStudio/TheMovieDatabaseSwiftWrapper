...
extension Client{
  ...
  static func discover(_ api_key: String, baseURL: String!, sort_by: String?, certification_country: String?, certification: String?, certification_lte: String?,  include_adult: Bool?, include_video: Bool?, release_type: ReleaseType? = nil,  primary_release_year: String?, primary_release_date_gte: String?, primary_release_date_lte: String?, release_date_gte: String?, release_date_lte: String?,  air_date_gte: String?, air_date_lte: String?, first_air_date_gte: String?, first_air_date_lte: String?, first_air_date_year: String?, language: String?, page: Double?,  timezone: String?, vote_average_gte: Double?, vote_average_lte: Double?, vote_count_gte: Double?, vote_count_lte: Double?, with_genres: String?, with_cast: String?, with_crew: String?, with_companies: String?, with_keywords: String?, with_people: String?,  with_networks: String?, year: Float?, certification_gte: String?, completion: @escaping (ClientReturn) -> ()) -> URLSessionTask{
    ...
    if(release_type != nil){
        parameters["with_release_type"] = release_type as AnyObject?
    }
